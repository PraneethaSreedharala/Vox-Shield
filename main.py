...
def main():
    ...
    frontend_script = project_root / "frontend" / "app_realtime.py"
        ...
        while True:
            ...
            for i, process in enumerate(processes):
                if process.poll() is not None:
                    ...
                    print(f"WARNING: {name} process terminated with code {process.returncode}")
                    cleanup()
                    return
